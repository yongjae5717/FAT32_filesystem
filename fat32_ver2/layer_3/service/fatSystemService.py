from fat32_ver2.layer_1.service.bootRecordService import *
from fat32_ver2.layer_1.service.fatTableService import *
from fat32_ver2.layer_2.service.nodeStreamService import *
...
class FatSystemService:
    ...
    def BuildFileSystem(self):
        ...
        self.directory_entry = self.directory_entry_service.make_data_area (self.boot_record, self.boot_record.get_data_region())
